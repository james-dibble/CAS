...
public abstract class ServletBootstrapper implements ServletContextListener
{
    ...
    protected abstract void InitContext(ServletContextEvent sce) throws Exception;
    ...
    /**
     * Add a singleton object to the servlet context to be resolved by it's type
     * name.
     *
    ...
    /**
     * Add a singleton object to the servlet context to be resolved by an
     * identifier.
     *
     * @param objectToBind The instance to use for it's type.
